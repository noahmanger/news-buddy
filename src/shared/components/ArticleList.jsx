      ...
      <div className="column is-three-quarters">
        <div className="level">
          <div className="level-left">
            <h2 className="title is-2 is-spaced level-item">News from {sources[this.props.source]}</h2>
          </div>
        ...
        <p>
          {this.props.isSavingArticles && <progress className="progress is-full-width is-primary" value={this.props.savedArticleCount} max="10"></progress> }
        </p>
        {articles}
      </div>
    )
